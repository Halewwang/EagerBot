...
const VISIBILITY_OPTIONS: Array<{
...
}> = [
  {
    value: "private",
    title: "私有",
    description: "只有你可以查看它并与它开启频道。",
  },
  {
    value: "public",
    title: "公开",
    description: "此部署中的所有人都可以找到并使用它。",
  },
];
...
const KIND_OPTIONS: Array<{
...
}> = [
  {
    value: "builtin",
    title: "内置",
    description: "运行在此部署自身的智能体上。无需托管或连接，创建后即可使用。",
  },
  {
    value: "managed",
    title: "托管",
    description:
      "运行在你托管的智能体上，通过 AG-UI 通信。此服务器会在每次运行时访问你的端点。",
  },
];
...
function CreateAgentWizard({
  ...
  return (
    <>
      ...
      <DialogTitle className="sr-only">新建智能体</DialogTitle>
...
function IdentityStep({
  ...
  return (
    <StepItem name="identity">
      <QuestionnaireTitle>这个智能体是谁？</QuestionnaireTitle>
      <QuestionnaireDescription>
        这里填写的角色描述会应用于该智能体参与的每个频道。
      </QuestionnaireDescription>
      <FieldGroup>
        <Field data-invalid={errors.name ? true : undefined}>
          <FieldLabel htmlFor="create-agent-name">名称</FieldLabel>
          <Input
        ...
        <Field data-invalid={errors.title ? true : undefined}>
          <FieldLabel htmlFor="create-agent-title">职称</FieldLabel>
          <Input
        ...
        <Field data-invalid={errors.roleDescription ? true : undefined}>
          <FieldLabel htmlFor="create-agent-role">角色描述</FieldLabel>
          <Textarea
...
function VisibilityStep({
  ...
  return (
    <StepItem name="visibility">
      <QuestionnaireTitle>谁可以看到它？</QuestionnaireTitle>
      <QuestionnaireChoices>
...
function KindStep({
  ...
  return (
    <StepItem name="kind">
      <QuestionnaireTitle>它运行在哪里？</QuestionnaireTitle>
      <QuestionnaireChoices>
      ...
      {kind === "managed" ? (
        <FieldGroup>
          <Field data-invalid={endpointError ? true : undefined}>
            <FieldLabel htmlFor="create-agent-endpoint">智能体端点</FieldLabel>
            ...
            {connection ? (
              ...
              <p className="text-muted-foreground text-sm">
                支持 AG-UI
                的智能体都可以使用。此服务器会访问你的智能体，因此本机上的智能体必须能从这里访问。
              </p>
            )}
          </Field>
          <Field>
