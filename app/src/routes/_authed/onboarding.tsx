  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <h1 className="text-3xl font-semibold tracking-tight max-w-md text-center">
        欢迎使用 {appConfig.brand.productName}
      </h1>
      <div className="h-32" />
      <AgentOrb size="72px" />
...
const AGENTS_PLACEHOLDER: RosterCard[] = [
  ...
  { id: "placeholder-data", name: "数据分析师", avatarSeed: "data-analyst" },
  {
            ...
            <div ref={ref}>
              ...
              >
                <Button
                  ...
                  size="lg"
                >
                  {complete.isPending ? "保存中…" : last ? "开始使用" : "继续"}
                </Button>
                {step !== 0 && (
                  <Button
                    className="w-full"
